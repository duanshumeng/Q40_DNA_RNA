...
runDashboard <- function(datType=NULL, isNorm = FALSE, 
    ...
    source('/Users/duanshumeng/生物信息/PGx_lab/HCC1395/ElementVSIllumina/RNAseq/ERCC_RNAseq/erccdashboard-main/R/geneExprTest.R')
    source('/Users/duanshumeng/生物信息/PGx_lab/HCC1395/ElementVSIllumina/RNAseq/ERCC_RNAseq/erccdashboard-main/R/testDECount.R')
