...
parser = argparse.ArgumentParser(description='Compare with Quartet reference datasets and calculate F1 score')
...
benchmarks={'D5':'/cpfs01/projects-HDD/cfff-e44ef5cf7aa5_HDD/dsm_23110700129/HCC1395_DNA/Quartet_high_confidence/LCL5.high.confidence.calls.vcf.gz',
           'D6':'/cpfs01/projects-HDD/cfff-e44ef5cf7aa5_HDD/dsm_23110700129/HCC1395_DNA/Quartet_high_confidence/LCL6.high.confidence.calls.vcf.gz',
           'F7':'/cpfs01/projects-HDD/cfff-e44ef5cf7aa5_HDD/dsm_23110700129/HCC1395_DNA/Quartet_high_confidence/LCL7.high.confidence.calls.vcf.gz',
           'M8':'/cpfs01/projects-HDD/cfff-e44ef5cf7aa5_HDD/dsm_23110700129/HCC1395_DNA/Quartet_high_confidence/LCL8.high.confidence.calls.vcf.gz'}    
...
if ref_set == 'yes':
    for a in aim_arr:
        ...
        print('hap.py {0} {1} -r {2} -T {3} -o {4} --threads {5}'.                                                                                 
                  format(HC_SNV,                                                                                                                       
                         input_dir+'/'+a,                                                                                                              
                         reference,                                                                                                                    
                         region,                                                                                                                       
...
stats_df.to_csv(out_dir+'/'+'F1score_stats_total_Quartet.csv',index=None)
